...
class Ransformer(torch.nn.Module):
    def __init__(self, **kwargs):
        ...
        self.transf1 = TransformerBlock(16, 16, yDIM=16, layers=[16, 32, 32, 8, 32, 32, 32, 8, 32, 16])
        self.transf2 = TransformerBlock(16, 16, yDIM=16, layers=[16, 32, 32, 32, 16])
        self.transf3 = TransformerBlock(16, 16, yDIM=16, layers=[16, 32, 32, 8, 32, 32, 32, 8, 32, 16])
