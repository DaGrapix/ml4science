...
class Ransformer(torch.nn.Module):
    def __init__(self, **kwargs):
        ...
        self.transf1 = TransformerBlock(32, 32, yDIM=32, layers=[32, 64, 64, 64, 64, 32])
        self.transf2 = TransformerBlock(32, 32, yDIM=32, layers=[32, 64, 64, 64, 64, 32])
        self.transf3 = TransformerBlock(32, 32, yDIM=32, layers=[32, 64, 64, 64, 64, 32])
