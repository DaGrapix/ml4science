...
class Ransformer(torch.nn.Module):
    def __init__(self, **kwargs):
        ...
        self.transf1 = TransformerBlock(64, 64, yDIM=64, layers=[64, 128, 128, 128, 64])
        self.transf2 = TransformerBlock(64, 64, yDIM=64, layers=[64, 128, 128, 128, 64])
        self.transf3 = TransformerBlock(64, 64, yDIM=64, layers=[64, 128, 128, 128, 64])
